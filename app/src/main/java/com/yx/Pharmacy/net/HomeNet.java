    ...
    private static OkHttpClient okHttpClient = new OkHttpClient.Builder()
                         .addInterceptor(new Interceptor() {
                             ...
                             public Response intercept(Chain chain) throws IOException
                             {
                                 ...
                                 builder.addHeader("token", NetUtil.isStringNull(NetUtil.getToken()));
                                 builder.addHeader("version", "v1");
                                 builder.addHeader("platform", "android");
                                 builder.addHeader("storeid", NetUtil.isStringNull(NetUtil.getStoreid()));
                                 builder.addHeader("itemid", NetUtil.isStringNull(NetUtil.getItemId()));
