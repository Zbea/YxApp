...
package com.yx.Pharmacy.zxing.view;
...
//        radio= SpUtils.getInstance(context).getFloat(SpUtils.SpKey.radio,1f);
        //初始化自定义属性信息
...
//        paint.setTextSize(Math.round(labelTextSize*radio));
        paint.setTextAlign(Paint.Align.CENTER);
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT*3/2, paint);
