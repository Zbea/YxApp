...
public class CategoryGridAdapter extends BaseQuickAdapter<DrugModel,BaseViewHolder> {
    ...
    public CategoryGridAdapter(Context context, @LayoutRes int layoutResId, @Nullable List<DrugModel> data,int model) {
