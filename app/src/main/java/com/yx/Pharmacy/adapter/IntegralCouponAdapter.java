...
public class IntegralCouponAdapter
        extends BaseQuickAdapter<CreditData.CouponListBean,BaseViewHolder> {



    public IntegralCouponAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, CreditData.CouponListBean item) {
