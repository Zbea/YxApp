...
public class CategoryDetailActivity extends BaseActivity implements CategoryGridAdapter.AddListener, ICategoryDetailView {
    ...
    private void initView() {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                //TODO 刷新
                page=1;
                mPresenter.getProductList(CategoryDetailActivity.this,page,catid,curType,isUp,true);
            }
        });
        addListener();
    ...
    private void addListener() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailActivity.startActivity(CategoryDetailActivity.this,String.valueOf(mAdapter.getData().get(position).getItemid()));
            }
        });
    ...
    public void addCart(DrugModel item, ImageView imgview) {
        if (TextUtils.isEmpty(NetUtil.getToken())) {
            LoginActivity.startActivity(CategoryDetailActivity.this,1);
            return;
        }else if(TextUtils.isEmpty(NetUtil.getStoreid())){
            if (mSelectStoreUtil!=null) {
                mSelectStoreUtil.loadMyShop(CategoryDetailActivity.this,true);
                return;
            }else {
                mSelectStoreUtil = new SelectStoreUtil(CategoryDetailActivity.this, () -> {
                    page = 1;
                    mPresenter.getProductList(this,page,catid,curType,isUp,true);
                });
            }
...
//        float toY = endLoc[1] - iv_shopping_car.getHeight()-goods.getHeight()-DensityUtils.dp2px(this,30);
    ...
    private void initNestPage() {
        ...
        mPresenter.getProductList(CategoryDetailActivity.this,page+1,catid,curType,isUp,false);
    }
